...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <header id="header" class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
        <a href="/" class="d-flex align-items-center col-md-3 mb-2 mb-md-0 text-dark text-decoration-none">
            <img src="{{asset('front/assets/img/logo.png')}}" alt="logo site">
        </a>
        ...
        <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
            ...
            <li><a href="#" class="nav-link px-2 link-dark">Ressources</a></li>
            <li><a href="{{ route('carte') }}" class="nav-link px-2 link-dark">Carte</a></li>
            <li><a href="#" class="nav-link px-2 link-dark">Alerte</a></li>
        </ul>

        <div class="col-md-3 calltracker text-end">
            <button type="button" class="btn btn-outline-primary me-2">Afficher numéro</button>
        </div>
    </header>   
        {{ $slot }}
    <div class="container">
    <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
        ...
        <span class="mb-3 mb-md-0 text-muted">&copy; 2023 M2 GDIL SAT, Inc</span>
        </div>
