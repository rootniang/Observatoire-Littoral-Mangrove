<x-app-layout>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      <h1 class="h2">Liste des espèces animales</h1>
      <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group me-2">
          <a href="{{ route('faune.create') }}"><button type="button" class="btn btn-sm btn-outline-secondary">Ajouter</button></a>
    ...
    <div>
        ...
        <span class="emptytable">Pas d'espèces animales dans la base</span>
        @endforelse
        {{ $especes->links() }}
    </div>
</x-app-layout>
